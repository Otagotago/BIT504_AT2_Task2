...
public class Board {
	...
	public Board() {
	 ...
	 //TODO: DONE initialise the cells array using ROWS and COLS constants 
		...
		// This creates a new 2D array which is determined by the ROWS and COLS constants
	...
	public boolean isDraw() {
		...
		for (int row =0; row < GameMain.ROWS; ++row) {
			...
			}		// Broke down into four sections for easier creation and readability
					// Checks if all cells are empty, if not, then returns a false value
					// If it returns a true value, then the game is a draw
		}

			return true; // Showed an error where it needed a return value, added true here
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		// Tried to just simply copy and paste from rows but it did the rows rather than columns 
