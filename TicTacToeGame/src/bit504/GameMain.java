...
public class GameMain extends JPanel implements MouseListener{
	...
	// Added a serialVersionUID as I was getting an error "The serializable class GameMain does not declare a static final serialVersionUID field of type long"
	...
	private enum GameState { // Found the GameState enums in the paintComponent constructor (different enums = different states of game)
		Playing, 
		Draw,
		Cross_won,
		Nought_won,
	...
	public GameMain() {   
		...
		this.addMouseListener(this); // Added MouseListener so it can respond to user clicks
		...
		initGame(); // Found from the public void initGame() method
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	         public void run() {
				...
				GameMain newContentPane = new GameMain(); // Creates a new object of the GameMain class
				frame.setContentPane(newContentPane); // Creates a new main content area for the application
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				statusBar.setText("X's Turn"); // Displays a message when it is "X"'s turn
				...
				statusBar.setText("O's Turn"); // Displays a message when it is "O"'s turn
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				currentState = GameState.Draw;  // The result if the gmae is a draw
	...
	public void mouseClicked(MouseEvent e) {  
		...
		repaint(); // A command that redraws the componenets in the paintComponent() method
